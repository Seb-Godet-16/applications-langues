...
{id:'verb',level:1,emoji:'📝',name:'Los Verbos',sub:'Les Verbes',
 words:[
   ...
   {es:'Vender',fr:'Vendre',em:'🏷️',conj:{es:['Yo vendo','Tú vendes','Él/Ella vende','Nosotros vendemos','Vosotros vendéis','Ellos/Ellas venden'],fr:['Je vends','Tu vends','Il/Elle vend','Nous vendons','Vous vendez','Ils/Elles vendent']}},
...
{id:'adj',level:1,emoji:'🆚',name:'Los Adjetivos Básicos',sub:'Les Adjectifs de Base',
 words:[
...
{id:'conn',level:1,emoji:'🔗',name:'Los Conectores',sub:'Les Mots de Liaison',
 words:[
  {es:'Y',fr:'Et',em:'➕'},
  {es:'O',fr:'Ou',em:'🔀'},
...
{id:'adv',level:1,emoji:'⏳',name:'Cantidad, Frecuencia y Tiempo',sub:'Quantité, Fréquence et Temps',
 words:[
...
{id:'securite',level:1,emoji:'🚨',name:'La Seguridad',sub:'La Sécurité',
 words:[
...
{id:'dinero',level:1,emoji:'💰',name:'El Dinero',sub:'L\'Argent',
 words:[
